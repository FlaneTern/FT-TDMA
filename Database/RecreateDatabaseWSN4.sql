drop database if exists WSN4;

create database WSN4;
use WSN4;
...
-- placeholder
insert into SimulationFTTDMA values(0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
insert into SimulationRRTDMA values(0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL);
